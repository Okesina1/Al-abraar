      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="mt-8 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="text-xs text-gray-600 space-y-1">
            <p><strong>Admin:</strong> admin@al-abraar.com / password</p>
            <p><strong>Ustaadh:</strong> ustaadh@al-abraar.com / password</p>
            <p><strong>Student:</strong> student@al-abraar.com / password</p>
          </div>
        </div>
      </div>
    </div>

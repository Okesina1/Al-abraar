    ...
    <div className="min-h-screen flex items-center justify-center bg-yellow-50 p-6">
      <div className="bg-white rounded-2xl shadow-md max-w-xl w-full p-8 text-center">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <a
            href="mailto:alabraaracademy.ng@gmail.com"
            className="text-blue-600"
          >
            alabraaracademy.ng@gmail.com
          </a>
          .
        </p>
        <p className="text-gray-600 mb-6">
          You will not be able to access your dashboard until your account is
          re-activated.
        </p>
        <div className="flex items-center justify-center space-x-3">
          <Link to="/" className="px-4 py-2 bg-gray-100 rounded-lg">
            Return to home
          </Link>
          <a
            href="mailto:alabraaracademy.ng@gmail.com"

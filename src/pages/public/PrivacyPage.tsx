...
const PRIVACY_CONTENT = {
  ...
  en: {
    ...
    sections: {
      overview: {
        title: "1. Overview",
        p1: "This Privacy Policy explains how Al‑Abraar collects, uses, discloses, and safeguards your information when you use our Services. By using the Services, you consent to the practices described in this Policy.",
      },
      ethic: {
        ...
        items: [
          {
            ...
            text: "name, email, password, role, profile details.",
          },
          {
            label: "Booking and Payment Data:",
            text: "schedule selections, payment metadata (processed by payment providers).",
          },
          {
            label: "Communications:",
            text: "messages, support requests, feedback.",
          },
          {
            label: "Usage Data:",
            text: "device, browser, pages viewed, actions taken, IP address, and approximate location.",
          },
          {
            label: "Cookies and Similar Technologies:",
            text: "as described in our Cookie Policy.",
          },
        ],
      },
      use: {
      ...
      bases: {
        ...
        p1: "Where applicable (e.g., in the EEA/UK), we process personal data under legal bases including consent, contract performance, legitimate interests, legal obligations, and protection of vital interests.",
      },
      share: {
      ...
      transfers: {
        ...
        p1: "We may transfer, store, and process information in countries other than your own. Where required, we use appropriate safeguards such as Standard Contractual Clauses.",
      },
      retention: {
        title: "7. Data Retention",
        p1: "We retain personal data only as long as necessary to fulfill the purposes outlined in this Policy, comply with our legal obligations, resolve disputes, and enforce agreements.",
      },
      rights: {
        title: "8. Your Rights",
      ...
      children: {
        ...
        p1: "Our Services are not directed to children under the age of 13 (or the age of consent in your jurisdiction). If you believe we have collected data from a child, please contact us to request deletion.",
      },
      security: {
        title: "10. Security",
        p1: "We implement technical and organizational measures to protect your data; however, no method of transmission or storage is completely secure. We cannot guarantee absolute security.",
      },
      thirdparty: {
        title: "11. Third‑Party Links and Services",
        p1: "Our Services may contain links to third‑party sites or services. We are not responsible for their privacy practices. We encourage you to review their policies.",
      },
      changes: {
        title: "12. Changes to this Policy",
        p1: "We may update this Policy from time to time. Material changes will be posted on this page with a new “Last updated” date. Continued use of the Services indicates acceptance of the updated Policy.",
      },
      contact: {
        title: "13. Contact Us",
        p1: "For privacy inquiries or to exercise your rights, contact us at alabraaracademy.ng@gmail.com.",
      },
    },
  },
  ar: {
    ...
    sections: {
      overview: {
        title: "1. نظرة عامة",
        p1: "توضح هذه السياسة كيفية جمع واستخدام والكشف عن معلوماتك ��حمايتها عند استخدامك لخدماتنا. باستخدامك للخدمات، فإنك توافق على الممارسات الموضحة في هذه السياسة.",
      },
      ethic: {
        ...
        items: [
          {
            ...
            text: "الاسم، البريد الإلكتروني، كلمة المرور، الدور، تفاصيل الملف ال��خصي.",
          },
          {
            label: "بيانات الحجز والدفع:",
            text: "اختيارات الجداول، وبيانات الدفع الوصفية (تُعالج لدى مزودي الدفع).",
          },
          {
            label: "الاتصالات:",
            text: "الرسائل وطلبات الدعم والتغذية الراجعة.",
          },
          {
            label: "بيانات الاستخدام:",
            text: "الجهاز والمتصفح والصفحات المعروضة والإجراءات المتخذة وعنوان IP والموقع التقريبي.",
          },
          {
            label: "الكوكيز والتقنيات المماثلة:",
            text: "كما هو موضح في سياسة الكوكيز.",
          },
        ],
      },
      use: {
      ...
      bases: {
        title: "4. ا��أسس القانونية للمعالجة",
        p1: "عند الاقتضاء (مثل المنطقة الاقتصادية الأوروبية/المملكة المتحدة) نعالج البيانات بناءً ��لى أسس قانونية تشمل الموافقة وأداء العقد والمصالح المشروعة والالتزامات القانونية وحماية المصالح الحيوية.",
      },
      share: {
      ...
      transfers: {
        title: "6. التحويلات الدولية للبيانات",
        p1: "قد ننقل معلوماتك أو نخزنها أو نعالجها في دول غير دولتك. عند الحاجة نستخدم ضمانات مناسبة مثل البنود التعاقدية القياسية.",
      },
      retention: {
        title: "7. الاحتفاظ بالبيانات",
        p1: "نحتفظ بالبيانات الشخصية فقط للمدة اللازمة لتحقيق الأغراض المذكورة في هذه السياسة والامتثال للالتزامات القانونية وحل النزاعات وتنفيذ الاتفاقيات.",
      },
      rights: {
        title: "8. حقوقك",
      ...
      children: {
        ...
        p1: "لا تُوجَّه خدماتنا للأطفال دون 13 عامًا (أو سن الموافقة في بلدك). إذا اعتقدت أننا جمعنا بيانات من طفل، فالرجاء التواصل لطلب الحذف.",
      },
      security: {
        title: "10. الأمان",
        p1: "نعتمد تدابير تقنية وتنظيمية لحماية بياناتك، ومع ذلك لا توجد وسيلة نقل أو تخزين آمنة تمامًا. لا يمكننا ضمان الأمان المطلق.",
      },
      thirdparty: {
        title: "11. روابط وخدمات الطرف الثالث",
        p1: "قد تحتوي خدماتنا على روابط لمواقع أو خدمات طرف ثالث ولسنا مسؤولين عن ممارساتهم ونشجعك على مراجعة سياساتهم.",
      },
      changes: {
        title: "12. تغييرات على هذه السياسة",
        p1: 'قد نحدّث هذه السياسة من وقت لآخر. سيتم نشر التغييرات الجوهرية هنا مع تاريخ "آخر تحديث" جديد. استمرارك في استخدام الخدمات يعني قبولك التحديثات.',
      },
      contact: {
        title: "13. تواصل معنا",
        p1: "للاستفسارات المتعلقة بالخصوصية أو لممارسة حقوقك: alabraaracademy.ng@gmail.com.",
      },
    },
  },
} as const;

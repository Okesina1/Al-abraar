...
const PRIVACY_CONTENT = {
  ...
  ar: {
    ...
    sections: {
      overview: { title: '1. نظرة عامة', p1: 'توضح هذه السياسة كيفية جمع واستخدام والكشف عن معلوماتك ��حمايتها عند استخدامك لخدماتنا. باستخدامك للخدمات، فإنك توافق على الممارسات الموضحة في هذه السياسة.' },
      ethic: {
      ...
      collect: {
        ...
        items: [
          { label: 'معلومات الحساب:', text: 'الاسم، البريد الإلكتروني، كلمة المرور، الدور، تفاصيل الملف ال��خصي.' },
      ...
      bases: { title: '4. ا��أسس القانونية للمعالجة', p1: 'عند الاقتضاء (مثل المنطقة الاقتصادية الأوروبية/المملكة المتحدة) نعالج البيانات بناءً ��لى أسس قانونية تشمل الموافقة وأداء العقد والمصالح المشروعة والالتزامات القانونية وحماية المصالح الحيوية.' },
      share: {
      ...
      retention: { title: '7. الاحتفاظ بالبيانات', p1: 'نحتفظ بالبيانات الشخصية فقط للمدة اللازمة لتحقيق الأغراض المذكورة في هذه السياسة والامتثال للالتزامات القانونية وحل النزاعات وتنفيذ الاتفاقيات.' },
      rights: {
        title: '8. حقوقك',
      ...
      thirdparty: { title: '11. روابط وخدمات الطرف الثالث', p1: 'قد تحتوي خدماتنا على روابط لمواقع أو خدمات طرف ثالث ولسنا مسؤولين عن ممارساتهم ونشجعك على مراجعة سياساتهم.' },

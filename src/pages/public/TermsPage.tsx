  ...
  ar: {
    ...
    sections: {
      ...
      spiritual: {
        ...
        q1: '﴿وَأَوْفُوا بِعَهْدِ اللَّهِ إِذَا عَاهَدْتُمْ وَلَا تَنْقُضُوا الْأَيْمَانَ بَعْدَ تَوْكِيدِهَا وَقَدْ جَعَلْتُمُ اللَّهَ عَلَيْكُمْ كَفِيلًا﴾',
        q1ref: 'القرآن 16:91',
      ...
      accounts: { title: '3. الح��ابات والأمان', items: [ 'أنت مسؤول عن سرية بيانات الدخول لحسابك.', 'أبلغنا فورًا عن أي استخدام غير مصرح به لحسابك.', 'يجوز لنا إيقاف أو إنهاء الحسابات المخالفة أو ذات المخاطر الأمنية.' ] },
      bookings: { title: '4. الحجوزات والمدفوعات والاسترداد', items: [ 'يجوز للطلاب حجز الدروس مع المعلمين وفق التوفر على المنصة.', 'تُعالج المدفوعات بأمان عبر مزودي الدفع (مثل سترايب). قد تُطبق رسوم وضرائب إضافية.', 'يخضع الاسترداد لسياساتنا والقانون المعمول به. قد تكون بعض الرسوم غير قابلة للاسترداد.', 'لا يُسمح بالتعاملات النقدية خارج المنصة للدروس المحجوزة.' ] },
      ...
      teacher: { title: '6. التزامات ا��معلم', items: [ 'يلتزم المعلمون بدقة البيانات والسلوك المهني دائمًا.', 'لا يجوز استدراج مدفوعات أو تواصل خارج المنصة.', 'يلتزم المعلمون بالقوانين المحلية والضرائب والشهادات اللازمة.' ] },
      ...
      use: { title: '8. الاستخدام المقبول والمحظور', items: [ 'يُمنع التحرش وخطاب الكراهية والسلوك المسيء.', 'يُمنع انتهاك الملكية الفكرية أو الخصوصية.', 'يُمنع البرمجيات الخبيثة والاختراق والكشط والوصول الآلي غير المصرح.', 'يُمنع أي محتوى يخالف القوانين أو المعايير المجتمعية.' ] },
      ip: { title: '9. الملكية الفكرية', p1: 'تعود ملكية الخدمات ومحتواها وبرمجياتها وعلاماتها أو تُرخص للبراء ومحميّة بقوانين الملكية الفكرية. لا يجوز ��ستخدام العلامات أو المحتوى دون إذن خطي مسبق.' },
      ...
      liability: { title: '11. تحديد المسؤولية', p1: 'ضمن الحدود التي يسمح بها القانون، لا تتحمل البراء أي أضرار غير مباشرة أو خاصة أو تبعية أو عقابية، ولا خسائر الأرباح أو الإيرادات أو البيانات أو السمعة نتيجة استخدامك للخدمات أو العجز عن استخدامها.' },

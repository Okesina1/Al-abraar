...
export class NotificationsService {
  ...
  async notifyUstaadhApproval(ustaadhId: string, email: string, fullName: string): Promise<void> {
    ...
    await this.sendEmail(email, 'Al-Abraar - Application Approved!', emailContent);
  }

  async notifyNewBooking(ustaadhId: string, studentName: string, packageType: string): Promise<void> {
    await this.createNotification(
      ustaadhId,
      'New Booking Request',
  ...
  async notifyBookingConfirmation(studentId: string, ustaadhName: string): Promise<void> {
    await this.createNotification(
      studentId,
      'Booking Confirmed',
